...
namespace Nimblist.data.Migrations
{
    ...
    [Migration("20260517195740_AddIsComplimentaryAccess")]
    partial class AddIsComplimentaryAccess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nimblist.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsComplimentaryAccess")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Nimblist.Data.Models.LlmSettings", b =>
                {
                    ...
                    b.Property<string>("ImageSearchApiKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Nimblist.Data.Models.UserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PayPalSubscriptionId")
                        .HasDatabaseName("IX_UserSubscriptions_PayPalSubscriptionId");
            ...
            modelBuilder.Entity("Nimblist.Data.Models.UserSubscription", b =>
                {
                    b.HasOne("Nimblist.Data.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("Nimblist.Data.Models.UserSubscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
